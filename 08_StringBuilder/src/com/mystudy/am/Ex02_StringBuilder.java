...
public class Ex02_StringBuilder {
	public static void main(String[] args) {
		//StringBuilder 클래스 , StringBuffer나 StringBuiler는 유사하다.
		//StringBuilder 단일 스레드(thread)로 돌아갈 때 안전하다.
		//특정한 경우가 아니면 StringBuilder를 사용한다
		//
		...
		System.out.println("sb.capacity(): " + sb.capacity()); //StringBuilder에는 크기, 용량을 뜻하는 capacity가 존재(여유공간까지 포함)
		...
		System.out.println("sb : " + sb); //StringBuilder은 원본데이터가 바뀜.
