...
public class StudentManager {
	...
	public StudentVO selectOne(String id) {
		...
		//list에 있는 데이타를 전달받은 id와 동일한 이름의 데이타가 있으면 리턴
		//없으면 null 리턴
	...
	public StudentVO selectOne(StudentVO vo) {
		StudentVO result = null;
		//list에 있는 데이타를 전달받은 vo의 name과 동일한 이름의 데이타가 있으면 리턴
		//없으면 null 리턴
	...
	public int delete(StudentVO vo) {
		int result = 0;
		//전달받은 vo의 name이 list에 있으면 삭제처리(성공시 1 리턴, 실패시 0리턴)
		//전달받은 vo의 name이 list에 없으면 "데이타 없어서 삭제 못함" 출력(0 리턴)
	...
	public int delete(String id) {
		int result = 0;
		//전달받은 name이 list에 있으면 삭제처리(성공시 1 리턴, 실패시 0리턴)
		//전달받은 name이 list에 없으면 "데이타 없음" 출력(0 리턴)
